...
bool cae_microphone_array__msg__audio_stream__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("cae_microphone_array.msg._audio_stream.AudioStream", full_classname_dest, 50) == 0);
  }
  cae_microphone_array__msg__AudioStream * ros_message = _ros_message;
  {  // header
  ...
  {  // encoding
    ...
    ros_message->encoding = (uint8_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // is_bigendian
...
{
  /* NOTE(esteve): Call constructor of AudioStream */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("cae_microphone_array.msg._audio_stream");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "AudioStream");
  ...
  {  // encoding
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->encoding);
    {
